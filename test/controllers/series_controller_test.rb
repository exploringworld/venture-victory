...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { name: @series.name, participant_teams: @series.participant_teams, start_date: @series.start_date, winner_team: @series.winner_team } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { name: @series.name, participant_teams: @series.participant_teams, start_date: @series.start_date, winner_team: @series.winner_team } }
